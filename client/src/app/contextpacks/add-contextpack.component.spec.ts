...
import { MockWordlistService } from 'src/testing/contextpack.service.mock';
...
describe('AddWordlistComponent', () => {
  ...
  describe('The age field', () => {
    ...
    beforeEach(() => {
      ageControl = addWordlistComponent.addWordlistForm.controls.age;
    });
  ...
  describe('The company field', () => {
    it('should allow empty values', () => {
      const companyControl = addWordlistForm.controls.company;
  ...
  describe('The email field', () => {
    ...
    beforeEach(() => {
      emailControl = addWordlistComponent.addWordlistForm.controls.email;
    });
  ...
  describe('The role field', () => {
    ...
    beforeEach(() => {
      roleControl = addWordlistForm.controls.role;
    });
