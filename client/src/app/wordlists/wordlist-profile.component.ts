...
@Component({
  selector: 'app-wordlist-profile',
  templateUrl: './wordlist-profile.component.html',
  styleUrls: ['./wordlist-profile.component.scss']
})
export class WordlistProfileComponent implements OnInit, OnDestroy {
